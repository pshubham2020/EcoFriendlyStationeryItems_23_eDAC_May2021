...
public interface OrderDetailRepository extends JpaRepository<OrderDetail, Long> {
	...
	@Query("select od from OrderDetail od join Order o on od.order = o.id where o.id in :id and o.customerEmail =:customerEmail and od.orderStatus =:orderStatus order by o.id desc")
	List<OrderDetail> findDeliveredItems(@Param("id") Set<Long> id, @Param("customerEmail")String customerEmail,@Param("orderStatus")String orderStatus);
} 