...
<title>Eco-Friendly Stationery Items | Checkout</title>
								...
								<div class="information-wrapper">
									<div class="first-row">
										<div class="controls form-group">
											<label class="col-form-label"><b>Your Name</b></label> <input
										...
										<div class="w3_agileits_card_number_grids">
											<div class="w3_agileits_card_number_grid_left form-group">
												<div class="controls">
													<label class="col-form-label"><b>Phone Number</b></label> <input
														type="text" class="form-control" value="${phone}"
											...
											<div class="w3_agileits_card_number_grid_right form-group">
												<div class="controls">
													<label class="col-form-label"><b>Pin Code</b> [As
														of now product delivery for pin code 411041 is available.]</label>
										...
										<div class="controls form-group">
											<label class="col-form-label"><b>Select Address
													Type</b></label> <select class="option-w3ls" name="addressType"
												required="required">
												<option>Home</option>
									...
									<div class="col-sm-12 text-left">
										<input type="submit" id="submit"
											class="btn btn-success btn-md center-block" value="Buy"
											style="width: 100px;" /> &emsp;<input type="button"
											class="btn btn-danger reset" value="Clear"
											style="width: 100px;" />
									</div>
								</div>
							</div>
