...
<c:if test="${empty email}">
	...
	<title>Eco-Friendly Stationery Items | My Cart</title>
...
<button type="button" class="btn btn-primary">
  Total Savings: <span class="badge badge-light">&#x20b9;${total_saving}</span>
			...
			<h5 class="mb-sm-4 mb-3 text-danger" style="font-weight: bold;">Note: As of now only Cash on Delivery (COD) payment mode is available.</h5>
								<div class="first-row">
