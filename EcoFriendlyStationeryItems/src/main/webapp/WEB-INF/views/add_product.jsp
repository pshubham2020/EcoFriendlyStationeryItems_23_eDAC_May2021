...
<html>
<head>
	<title>Eco-Friendly Stationery Items | Add Product </title>
	<jsp:include page="layouts/header.jsp"></jsp:include>
</head>
<body>
	<jsp:include page="layouts/admin_navigation.jsp"></jsp:include>
...
<!-- log in -->
	...
	<div class="alert alert-info alert-dismissible fade show text-center">
			Note: Recommended image size is 800x533 in pixel.
			</div>
<!-- register -->
